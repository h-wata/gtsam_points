...
public:
  ...
  Eigen::Vector4f* voxel_colors; ///< Voxel RGB colors
};
...
std::vector<Eigen::Vector4f> download_voxel_colors(const GaussianVoxelMapGPU& voxelmap, CUstream_st* stream = nullptr);
